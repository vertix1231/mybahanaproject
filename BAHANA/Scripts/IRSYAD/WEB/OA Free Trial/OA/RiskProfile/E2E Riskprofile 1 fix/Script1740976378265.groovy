...
WebUI.takeScreenshot(('D:\\KULIAH DAN KERJA\\KERJA\\bahana bug\\fix\\' + GlobalVariable.email) + '\\risprofile2.jpg')

WebUI.click(findTestObject('Web/OA/Continue OA Process/Approval n Risk Profile/riskprofile/btnNextriskprofile/btnNextriskprofile'))

Thread.sleep(1000)

WebUI.takeScreenshot(('D:\\KULIAH DAN KERJA\\KERJA\\bahana bug\\fix\\' + GlobalVariable.email) + '\\risprofile3.jpg')
