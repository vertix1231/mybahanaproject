...
WebUI.takeScreenshot(('D:\\KULIAH DAN KERJA\\KERJA\\bahana bug\\fix\\' + GlobalVariable.email) + '\\oa_datainfobankABN_AMRO1.jpg')
...
WebUI.takeScreenshot(('D:\\KULIAH DAN KERJA\\KERJA\\bahana bug\\fix\\' + GlobalVariable.email) + '\\oa_datainfobankABN_AMRO2.jpg')
...
WebUI.takeScreenshot(('D:\\KULIAH DAN KERJA\\KERJA\\bahana bug\\fix\\' + GlobalVariable.email) + '\\oa_datainfobankABN_AMRO3.jpg')

WebUI.setText(findTestObject('Web/OA/Continue OA Process/bankdatamaret2025/filledbankrdn/input_buttonfilledbankrdn'), 'bank central')

WebUI.sendKeys(findTestObject('Web/OA/Continue OA Process/bankdatamaret2025/filledbankrdn/input_buttonfilledbankrdn'), 
    Keys.chord(Keys.ENTER))

WebUI.takeScreenshot(('D:\\KULIAH DAN KERJA\\KERJA\\bahana bug\\fix\\' + GlobalVariable.email) + '\\oa_datainfobankABN_AMRO4.jpg')
...
WebUI.takeScreenshot(('D:\\KULIAH DAN KERJA\\KERJA\\bahana bug\\fix\\' + GlobalVariable.email) + '\\oa_datainfobankABN_AMRO4_1.jpg')
