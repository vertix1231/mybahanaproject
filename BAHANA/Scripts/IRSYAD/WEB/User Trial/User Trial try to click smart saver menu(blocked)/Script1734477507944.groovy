...
WebUI.click(findTestObject('Object Repository/Web/User Trial/Page_Bahana DXtrade Aplikasi Investasi Pasa_007838/button_More'))

WebUI.click(findTestObject('Object Repository/Web/User Trial/Page_Bahana DXtrade Aplikasi Investasi Pasa_007838/span_Smart Saver'))
